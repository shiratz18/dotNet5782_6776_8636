...
namespace ConsoleUI
{
    class Program
    {
        ...
        {
            Console.WriteLine(from s in data.GetStationList()
                              select s);
        }
        /// <summary>
        ...
        {
            Console.WriteLine(from d in data.GetDroneList()
                              select d);
        }
        /// <summary>
        ...
        {
            Console.WriteLine(from c in data.GetCustomerList()
                              select c);
        }
        /// <summary>
        ...
        {
            Console.WriteLine(from p in data.GetParcelList()
                              select p);
        }
        /// <summary>
        ...
        {
            Console.WriteLine(from p in data.GetParcelList(parcel => parcel.DroneId == 0)
                              select p);
        }
        /// <summary>
        ...
        public static void PrintAllAvailableChargeStations(IDal data)
        {
            ...
            Console.WriteLine(from s in data.GetStationList(station => station.ChargeSlots > 0)
                              select s);
        }
        /// <summary>
        ...
        {
            Console.WriteLine(from d in data.GetDroneChargeList()
                              select d);
        }
        #endregion
    }
